...
const PoliciesItemShipping = () => {
  return (
    <div className="col-12 col-md-4">
      <a href="/" className="policies-item">
        ...
        <span className="policies-text">Free Shipping &amp; Returns</span>
      </a>
    </div>
  );
};

const PoliciesItemPrice = () => {
  return (
    <div className="col-12 col-md-4">
      <a href="/" className="policies-item">
        <span className="policies-icon">
        ...
        <span className="policies-text">Lowest Price Guarantee</span>
      </a>
    </div>
  );
};

const PoliciesItemOffer = () => {
  return (
    <div className="col-12 col-md-4">
      <a href="/" className="policies-item">
        <span className="policies-icon">
...
export { PoliciesItemShipping, PoliciesItemPrice, PoliciesItemOffer };
